...
class Company{
    public Name:string;
    private establish:number
    public readonly city:string
    branch:string

    constructor(Name:string,establish:number,city:string,branch:string){
        this.Name=Name
...
class TCS extends Company{
    Bname:string
    constructor(Name:string,establish:number,city:string,branch:string,Bname:string){
...
class Student{
    ...
    public constructor(name:string,lastname:string,city:string){
        this.name=name
